...
console.log("🚀 ~ file: App.js ~ line 25 ~ getProductsFiltred ~ queryKey", queryKey)
...
return useQuery(["getProductsFiltred",data], (data) => getProductsFiltred(data));
}
function App() {
  ...
  const onSubmit = async () => {
      ...
      const brandsIds = [];
      const categoriesIds = [];
      categoriesChecked && categoriesChecked.map((e)=>{
      ...
      console.log("🚀 ~ file: App.js ~ line 85 ~ onSubmit ~ categoriesIds", categoriesIds)
      setFiltred({brand:brandsIds,category:categoriesIds,min:minpricechecked,max:maxpricechecked})
    ...
    <div className="App">
      ...
      <div className="app-container ">
        ...
        <div className="beforecard">
          <ProductList productsList={productsList} setproductsList={setproductsList} isLoading={isLoading} data={data} error={error} resetOnSubmit={resetOnSubmit} />
          <ItSupport />
        </div>
      </div>
      <Footer />
